...
export default function App() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: 'notif-1',
      message: 'Your access request for "System Design Interview Preparation" was approved!',
      time: '1 hour ago',
      read: false,
    },
    {
      id: 'notif-2',
      message: 'Emma Davis uploaded a new course: "Web Development Bootcamp".',
      time: '2 hours ago',
      read: true,
    },
    {
      id: 'notif-3',
      message: 'Reminder: "Project Submission Deadline" is coming up in 3 days.',
      time: '1 day ago',
      read: false,
    },
  ]);
  ...
  const [activities, setActivities] = useState<Activity[]>([
    {
      id: 'act-1',
      type: 'upload',
      message: 'Uploaded "Introduction to Machine Learning"',
      time: '1 day ago',
    },
    {
      id: 'act-2',
      type: 'review',
      message: 'Reviewed "Web Development Bootcamp" with 5 stars',
      time: '2 days ago',
    },
    {
      id: 'act-3',
      type: 'request',
      message: 'Requested access to "System Design Interview Preparation"',
      time: '3 days ago',
    },
  ]);
  ...
  const [calendarEvents, setCalendarEvents] = useState<CalendarEvent[]>([
    ...
    },
    {
      ...
      type: 'exam',
      description: 'Covers Net Present Value (NPV), Internal Rate of Return (IRR), and Economic Production Quantity (EPQ) calculations.',
    },
    {
      id: 'cal-7',
      ...
      type: 'class',
      description: 'Special guest lecture by industry experts on the future of network security and ethical hacking.',
    },
    {
      id: 'cal-8',
      ...
      type: 'deadline',
      description: 'Submit the final report for the Quantum Mechanics experiment via the student portal.',
    },
    {
      id: 'cal-9',
      ...
      type: 'reminder',
      description: 'Portal opens at 8:00 AM. Make sure you have your advisor-approved schedule ready.',
    },
  ]);
  ...
  const [resources, setResources] = useState<Resource[]>([
    ...
    {
      id: 'res-2',
      title: 'Cisco Router Configuration & Subnetting Guide',
      category: 'Documents',
      ...
      rating: 4.9,
      reviewCount: 42,
      description: 'Step-by-step guide for configuring Cisco 1841 and 1941 routers, including detailed IP subnetting exercises.',
      fullDetails: 'This comprehensive guide covers practical network configuration. Learn how to calculate subnet bits, configure router interfaces, and set up basic routing protocols using Cisco hardware.',
      topics: ['IP Subnetting', 'Cisco Packet Tracer', 'Router Interfaces', 'Network Hardware'],
      hasAccess: true,
      files: [
        { id: 'file-2-1', name: 'Subnetting_Cheatsheet.pdf', size: '1.2 MB', type: 'PDF' },
        { id: 'file-2-2', name: 'Router_Configs.pkt', size: '4.5 MB', type: 'PKT' }
      ],
      additionalInfo: {
        Duration: 'Self-paced',
        Level: 'Intermediate',
    ...
    {
      id: 'res-19',
      title: 'UI/UX Design & Frontend Prototyping',
      category: 'Courses',
      uploader: 'Jessica Lee',
      uploaderId: 'user-20',
      uploadDate: 'Jan 10, 2026',
      isPublic: true,
      rating: 4.9,
      reviewCount: 88,
      description: 'Learn the fundamentals of user interface design and structural layouts using Figma, HTML, and CSS box-sizing.',
      fullDetails: 'Complete guide to UI/UX design and frontend implementation. Covers color theory, layout structures (margin, padding, gap), wireframing, and creating responsive white-box dashboard components.\n\nIncludes real-world design briefs to build your portfolio.',
      topics: ['UI Design', 'CSS Layouts', 'Figma', 'Prototyping', 'Wireframing', 'HTML Structure'],
      hasAccess: true,
      files: [
        { id: 'file-19-1', name: 'Design_Theory_and_CSS.pdf', size: '15.2 MB', type: 'PDF' },
        { id: 'file-19-2', name: 'Dashboard_Templates.zip', size: '45.1 MB', type: 'ZIP' }
      ],
      additionalInfo: {
        Duration: '6 weeks',
        Level: 'Beginner',
    ...
    {
      id: 'res-20',
      title: 'Financial Analysis & Capital Budgeting Toolkit',
      category: 'Documents',
      uploader: 'Prof. David Miller',
      uploaderId: 'user-21',
      uploadDate: 'Jan 14, 2026',
      isPublic: true,
      rating: 4.8,
      reviewCount: 34,
      description: 'Comprehensive Excel models and PDF guides for calculating Cost of Capital, NPV, and IRR.',
      fullDetails: 'This toolkit provides pre-built, customizable Excel models for advanced financial analysis.\n\nIncludes detailed documentation on how to interpret Net Present Value (NPV), Internal Rate of Return (IRR), and apply Economic Production Quantity (EPQ) calculations to inventory management.',
      topics: ['Capital Budgeting', 'NPV', 'IRR', 'Cost of Capital', 'Financial Modeling', 'EPQ'],
      hasAccess: false,
      files: [
        { id: 'file-20-1', name: 'Financial_Models_Master.xlsx', size: '4.2 MB', type: 'Excel' },
        { id: 'file-20-2', name: 'Analysis_Guide.pdf', size: '2.8 MB', type: 'PDF' }
      ],
      additionalInfo: {
        Pages: '45 pages',
    ...
    },
    {
      ...
      rating: 4.6,
      reviewCount: 45,
      description: 'A fully functional AI chatbot built with Python, FastAPI, and OpenAI API integrations for customer support.',
      fullDetails: 'This project demonstrates how to build and deploy an intelligent chatbot capable of handling customer queries, routing complex issues to human agents, and maintaining conversation context.\n\nIncludes the complete backend code, frontend chat widget (React), and Docker deployment scripts.',
      topics: ['Artificial Intelligence', 'Python', 'FastAPI', 'React', 'OpenAI', 'Docker'],
      hasAccess: false,
      files: [
        { id: 'file-21-1', name: 'Chatbot_Source.zip', size: '18.4 MB', type: 'ZIP' },
        { id: 'file-21-2', name: 'API_Documentation.md', size: '245 KB', type: 'Markdown' },
        { id: 'file-21-3', name: 'Demo_Recording.mp4', size: '42.1 MB', type: 'Video' }
      ],
      additionalInfo: {
      ...
      externalLink: 'https://github.com/example/ai-chatbot'
    },
    {
      id: 'res-22',
      title: 'Advanced Engineering Physics Notes',
      category: 'Documents',
      uploader: 'Dr. Robert Oppenheimer',
      uploaderId: 'user-23',
      uploadDate: 'Jan 02, 2026',
      isPublic: true,
      rating: 4.9,
      reviewCount: 112,
      description: 'Complete lecture notes covering quantum mechanics, solid-state physics, and electromagnetism.',
      fullDetails: 'Handwritten and digitized lecture notes from the Advanced Engineering Physics 301 course. Features clear diagrams, mathematical proofs, and step-by-step problem-solving methodologies for complex physics equations.',
      topics: ['Quantum Mechanics', 'Electromagnetism', 'Solid-State Physics', 'Thermodynamics'],
      hasAccess: true,
      files: [
        { id: 'file-22-1', name: 'Physics_Complete_Notes.pdf', size: '45.8 MB', type: 'PDF' },
        { id: 'file-22-2', name: 'Formula_Cheat_Sheet.pdf', size: '1.5 MB', type: 'PDF' }
      ],
      additionalInfo: {
        Pages: '180 pages',
        Format: 'Scanned PDF (High Res)',
        Level: 'Undergraduate',
        Updated: 'January 2026'
      }
    },
    {
      id: 'res-23',
      title: 'Zero-Day Vulnerabilities in IoT Devices',
      category: 'Research',
      uploader: 'Dr. Anita Desai',
      uploaderId: 'user-24',
      uploadDate: 'Dec 28, 2025',
      isPublic: false,
      rating: 4.7,
      reviewCount: 29,
      description: 'A comprehensive study on security flaws in modern smart home devices and proposed mitigation frameworks.',
      fullDetails: 'This peer-reviewed paper exposes critical zero-day vulnerabilities across 50 popular Internet of Things (IoT) devices. It details the attack vectors, reverse engineering processes used, and proposes a lightweight encryption framework suitable for low-power microcontrollers.',
      topics: ['Cybersecurity', 'IoT', 'Zero-Day', 'Encryption', 'Network Security'],
      hasAccess: false,
      files: [
        { id: 'file-23-1', name: 'IoT_Security_Paper.pdf', size: '3.4 MB', type: 'PDF' },
        { id: 'file-23-2', name: 'Vulnerability_Data.csv', size: '12 MB', type: 'Excel' }
      ],
      additionalInfo: {
        'Paper Count': '1 main paper + dataset',
