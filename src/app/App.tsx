...
export default function App() {
  ...
  const handleSignup = async (formData: {
    ...
    try {
      ...
      setShowAuthModal(false);
      setCurrentView('dashboard');
      toast.success(`Account created! You received 20 bonus points!`, { icon: '🎉' });
      ...
      setActivities([
        {
          id: `act-${Date.now()}`,
          type: 'upload',
          message: `Uploaded "${resourceData.title}"`,
          time: 'Just now',
        },
        ...activities,
      ]);

      toast.success('Resource uploaded successfully! +2 points earned', { icon: '🎉' });
